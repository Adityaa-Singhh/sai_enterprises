...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "relative flex items-center justify-center size-10 cursor-pointer rounded-full bg-white dark:bg-white/10 text-slate-800 dark:text-white border border-slate-200 dark:border-white/20 p-2.5 transition-all duration-300 hover:scale-105 active:scale-95 shadow-sm focus:outline-none",
        className,
      )}
      onClick={toggleTheme}
    ...
    >
      ...
      <Sun
        className={cn(
          "h-[1.2rem] w-[1.2rem] transition-all duration-500 text-amber-500",
          isDark ? "scale-0 -rotate-90 opacity-0 absolute" : "scale-100 rotate-0 opacity-100"
        )}
      />
      <Moon
        className={cn(
          "h-[1.2rem] w-[1.2rem] transition-all duration-500 text-volt",
...
export const ModeToggle = ThemeToggleButton;
