...
export const products: Product[] = [
  {
    ...
    images: ['https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&w=600&q=80', 'https://images.unsplash.com/photo-1594582967676-cb2a543fbe3f?auto=format&fit=crop&w=600&q=80'],
    isFeatured: true,
    isNew: false,
    inStock: true,
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1620288627223-53302f4e8c74?auto=format&fit=crop&w=600&q=80'],
    isFeatured: true,
    isNew: true,
    inStock: true,
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1558486012-817176f84c6d?auto=format&fit=crop&w=600&q=80'],
    isFeatured: false,
    isNew: false,
    inStock: true,
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1550985543-f47f38aee65f?auto=format&fit=crop&w=600&q=80'],
    isFeatured: false,
    isNew: false,
    inStock: true,
